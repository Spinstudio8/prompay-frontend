...
const Card = ({ image, title, description, link }) => {
  return (
    <div className="w-4/5 md:w-[370px] mx-auto h-[380px] bg-white text-primaryBlue rounded-lg flex flex-col items-center justify-center hover:md:w-[383px] hover:md:h-[395px] hover:duration-500 ease-in-out">
      <img src={image} alt="" />
